    ...
    <div className="navbar bg-base-100/80 backdrop-blur-md shadow-lg rounded-xl border border-base-200 relative z-10">
      ...
      <div className="flex gap-2 items-center">
        ...
        <div className="dropdown dropdown-end relative z-50">
          ...
          >
            <li>
              <span className="justify-between hover:bg-base-200 rounded-lg transition-colors" onClick={() => {navigate('/college/onboard')}}>
                Profile
              </span>
            </li>
            <li>
              <span className="hover:bg-base-200 rounded-lg transition-colors" onClick={()=> {navigate('/teacher')}}>Dashboard</span>
            </li>
            <li>
                <span className="hover:bg-base-200 rounded-lg transition-colors" onClick={()=> {navigate('/teacher/attendance-mark')}}>Attendance</span>
            </li>
            <li>
                <span className="hover:bg-base-200 rounded-lg transition-colors" onClick={()=> {navigate('/teacher/addNenroll')}}>Subject & Enrollement</span>
            </li>
            <li>
